...
#include "custom_msg/srv/add_three_ints__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_custom_msg__srv__AddThreeInts_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_custom_msg__srv__AddThreeInts_Response(
    full_bounded, 0);
}
