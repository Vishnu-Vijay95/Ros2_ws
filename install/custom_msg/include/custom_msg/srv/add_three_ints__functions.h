...
#ifndef CUSTOM_MSG__SRV__ADD_THREE_INTS__FUNCTIONS_H_
#define CUSTOM_MSG__SRV__ADD_THREE_INTS__FUNCTIONS_H_
...
#endif  // CUSTOM_MSG__SRV__ADD_THREE_INTS__FUNCTIONS_H_
